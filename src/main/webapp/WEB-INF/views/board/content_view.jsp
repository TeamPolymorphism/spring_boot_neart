		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop how-shadow1">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->		
					<a href="/" class="logo">
						<img src="${pageContext.request.contextPath}/neart-source/logo/logo_b.png" alt="IMG-LOGO">
					</a>
	...
	<!--table-->
        ...
        <main class="p-t-50 m-t-10">
			...
			<tr>
				...
				<!-- sec:authorize access="hasRole('ADMIN')"> --><a type="button" class="btn btn-dark float-left m-r-10" href="/n_modify_view/${content_view.bid}">수정하기</a><!-- /sec:authorize> --> &nbsp;&nbsp;  
				</td>
			</tr>
				</tbody>
			</table>
