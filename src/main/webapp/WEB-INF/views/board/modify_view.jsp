			...
			<div class="wrap-menu-desktop how-shadow1">
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li><a href="${pageContext.request.contextPath}/listProduct">ART-PRODUCT</a></li>

							<li class="label1"><a href="${pageContext.request.contextPath}/subscription">SUBSCRIPTION
									(구독)</a></li>
	...
	<main class="p-t-50 m-t-10">
		<div class="container">
			<div class="d-flex justify-content-between">
				<h4 class="mb-0" style="font-weight: bold; color: black;">공지사항
					수정</h4>
			...
			<div class="container">
				<form action="/n_modify/${content_view.bid}" id="updateForm" name="form" method="post"
					...
					<input type="text" name="btitle" class="form-control" id="btitle" value="${content_view.btitle}">
				  </div>
				  
					<div class="form-group">
						<label for=content>내용</label>
						<textarea name="bcontent" class="form-control" id="bcontent" rows="3">${content_view.bcontent}</textarea>
					</div>
