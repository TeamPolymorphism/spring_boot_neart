                ...
                <div class="row">
                    ...
                    <div class="col-md-8 order-md-2" style="color: black;">
                               ...
                               <tbody style=" line-height: center;">
                                   <tr>
                                       <td style="overflow: hidden;">
                                           <img
                                               src="/neart-source/image/${receiptlist.productid}.jpg"
                                               class="card-img-top"
                                               alt="..."
                        ...
                        <table class="table mb-5">
                            <thead style="height: 20px;">
                                <tr style="height: 20px;">
                                    <th style="font-weight: normal; font-size: 15px; border-bottom: 1px solid rgb(189, 189, 189); ">주문금액</th>
                                    
                                    <th style="text-align: end; font-size: 15px; border-bottom: 1px solid rgb(189, 189, 189); border-right: 1px solid rgb(189, 189, 189);">
                                        <fmt:formatNumber value="${orderreceipt_view.price}" pattern="#,###" />원</th>
                                    <th style="color: red; font-size: 18px; border-bottom: 1px solid rgb(189, 189, 189); ">결제금액</th>
                                    
                                    <th style="color: red; text-align: end; font-size: 18px; border-bottom: 1px solid rgb(189, 189, 189);">
                                        <fmt:formatNumber value="${orderreceipt_view.price}" pattern="#,###" />원</th>
                                </tr>
                            </thead>
                            <!--<c:forEach var="dto" items="${list}">-->
