			...
			<table class="table">
			  ...
			  <tbody>
				<tr>
				  ...
				  <td> 
					  <img
						src="neart-source/image/0${detail.productid}.jpg"
						class="card-img-top"
						alt="..."
				  ...
				  <td style="line-height: 100px;">${detail.price}</td>
				</tr>
				...
				<div class="row row-cols-2 row-cols-4">
				  <div class="col-6 col-md-3">
					<div class="card shadow-sm" style="border: none;">
					  <img class="bd-placeholder-img card-img-top" width="150px" height="100%" src="neart-source/image/06.jpg"></img>
		  
					  <div class="card-body">
						<a href="#" class="card-text" style="color: black;">Square Neck Back</a>
					  </div>
					</div>
				  </div>
				  <div class="col-6 col-md-3">
					<div class="card shadow-sm" style="border: none;">
					  <img class="bd-placeholder-img card-img-top" width="150px" height="100%" src="neart-source/image/07.jpg"></img>
		  
					  <div class="card-body">
						<a href="#" class="card-text" style="color: black;">Mini Silver Mesh Watch</a>
					  </div>
					</div>
				  </div>
				  <div class="col-6 col-md-3">
					<div class="card shadow-sm" style="border: none;">
					  <img class="bd-placeholder-img card-img-top" width="150px" height="100%" src="neart-source/image/08.jpg"></img>
		  
					  <div class="card-body">
						<a href="#" class="card-text" style="color: black;">Traditional Asian House</a>
					  </div>
					</div>
				  </div>
				  <div class="col-6 col-md-3">
					<div class="card shadow-sm" style="border: none;">
					  <img class="bd-placeholder-img card-img-top" width="150px" height="100%" src="neart-source/image/09.jpg"></img>
		  
					  <div class="card-body">
						<a href="#" class="card-text" style="color: black;">Shirt in Stretch Cotton</a>
					  </div>
					</div>
				  </div>
				  <div class="col-6 col-md-3">
					<div class="card shadow-sm" style="border: none;">
					  <img class="bd-placeholder-img card-img-top" width="150px" height="100%" src="neart-source/image/10.jpg"></img>
		  
					  <div class="card-body">
						<a href="#" class="card-text" style="color: black;">Only Check Trouser</a>
					  </div>
					</div>
				  </div>
