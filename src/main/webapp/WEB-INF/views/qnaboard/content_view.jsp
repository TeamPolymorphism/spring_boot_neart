		...
		<div class="container">
			...
			<table class="table table-hover" style="color: black;">
				<tbody>
					...
					<tr>
						<td>내용</td>
						<td style="height: 150px;">${content_view.bcontent}</td>
					</tr>
					<tr>
						<td colspan="2"><a type="button" href="/qlist"
							class="btn btn-dark float-left m-r-10">목록</a> &nbsp;&nbsp; <sec:authorize
								access="isAuthenticated()">
								<c:if test="${principal.user.id == content_view.id}">
						...
						<a type="button" class="btn btn-dark float-left m-r-10"
								...
								<a type="button" class="btn btn-dark float-left m-r-10"
									href="/q_reply_view?bid=${content_view.bid}&bgroup=${content_view.bgroup}">답글달기</a>
							</sec:authorize> &nbsp;&nbsp;</td>
					</tr>
				</tbody>
			</table>
