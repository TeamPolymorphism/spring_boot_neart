	...
	<main class="p-t-50 m-t-10">
		<div class="container">
			<div class="d-flex justify-content-between">
				<h4 class="mb-0" style="font-weight: bold; color: black;">Q&A 답글</h4>
			</div>

			<hr class="mb-0" style="border: solid 2px black;">
			<div class="m-t-30"></div>
            <div class="container">
				<form action="/q_reply" name="form" method="post" onsubmit="return inputCheck()">
				
				<div class="form-group">
					<label for="subject">글번호</label>
					<input type="text" name="bid" class="form-control" id="subject"  name="subject" value="${reply_view.bid}" style="border:0;" readonly>
				  </div>
				  
				  <div class="form-group">
					<label for="subject">제목</label>
					<input type="text" name="btitle" class="form-control" id="subject"  name="subject" value="${reply_view.btitle}">
				  </div>
				  <div class="form-group">
					<label for=content>내용</label>
					<textarea name="bcontent" class="form-control" id="content" rows="3" >${reply_view.bcontent}</textarea>
				  </div>
