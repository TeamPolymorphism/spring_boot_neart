...
<body class="animsition">
	...
	<main class="p-t-50 m-t-10">
		<div class="container">
            ...
            <div class="container">
				<form action="/q_write" name="form" method="post" onsubmit="return inputCheck()">
				
				<div class="form-group">
					<label for="subject">작성자</label>
					<input type="text" name="id" class="form-control" id="subject"  name="subject" value="${principal.user.id}" style="border:0;" readonly>
				  </div>
