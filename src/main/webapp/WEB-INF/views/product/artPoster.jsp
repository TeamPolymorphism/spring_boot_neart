	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			...
			<div class="row isotope-grid">
				<c:forEach items="${artPoster}" var="artPoster">
					<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
						<!-- Block2 -->
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="${artPoster.filePath}" alt="IMG-PRODUCT" width="315" height="315">
							</div>

							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									<a href="detailProduct?productid=${artPoster.productid}"
										class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
										${artPoster.productname} </a> <span class="stext-105 cl3">
										<fmt:formatNumber
													value="${artPoster.price}" pattern="#,###" /> 원 </span>
								</div>
