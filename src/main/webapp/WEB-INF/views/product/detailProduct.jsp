							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="${detailProduct.filePath}">
									<div class="wrap-pic-w pos-relative">
										...
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="${detailProduct.filePath}">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<h4 class="mtext-104 cl3 p-t-23">
							Size : ${detailProduct.productsize} mm
						</h4>

						<h4 class="mtext-104 cl3 p-t-10">
							Artist : ${detailProduct.artist}
						</h4> 
