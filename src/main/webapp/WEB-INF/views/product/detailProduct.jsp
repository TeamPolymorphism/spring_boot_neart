...
<body class="animsition">
	...
	<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
			<a href="product-detail.html" class="stext-109 cl8 hov-cl1 trans-04">
				ART-PRODUCT
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="neart-source/image/01hover.jpg">
									<div class="wrap-pic-w pos-relative">
										<img src="neart-source/image/01hover.jpg" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="neart-source/image/01hover.jpg">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>

								<div class="item-slick3" data-thumb="neart-source/image/647-2.jpg">
									<div class="wrap-pic-w pos-relative">
										<img src="neart-source/image/647-2.jpg" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="neart-source/image/647-2.jpg">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>

								<div class="item-slick3" data-thumb="neart-source/image/01111.jpg">
									<div class="wrap-pic-w pos-relative">
										<img src="neart-source/image/01111.jpg" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="neart-source/image/01111.jpg">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<p class="stext-102 cl3 p-t-23">
							#타쿠반나이   #일본   #도쿄   #일러스트레이션   #인물   #풍선껌   #옐로우   #화이트   #정사각형   #리미티드에디션
						</p>
						...
						<div class="tab-pane fade show active" id="description" role="tabpanel">
							<div class="how-pos2 p-lr-15-md">
								<p class="stext-102 cl6">
									타쿠 반나이는 도코에서 활동하고 있는 일러스트레이터입니다. 그래픽 디자인을 전공하였고, 
									이후 몇 년간 상업광고의 콘티 작가로 활동했습니다. 하지만 광고가 완성되면 폐기되고 마는 콘티 작업의 
									숙명이 안타까워 과감히 전업 일러스트레이터의 길로 들어섰지요. 타쿠 반나이는 디테일을 과감히 생략한 단순함을 통해
									왁자지껄 어지러운 흐름에 떠밀려 지나치고 말았던 일상의 한 장면을 소중하게 담아냅니다. 투박한 듯 섬세한 그의
									표현 방식은 보는 이에게 담담한 위로를 전합니다.
