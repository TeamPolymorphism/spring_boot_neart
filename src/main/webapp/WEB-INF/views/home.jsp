				...
				<div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						...
						<a href=""
							class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8"> Album
								</span> <span class="block1-info stext-102 trans-04"> archiving
									album </span>
							</div>
				...
				<div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						...
						<a href=""
							class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8"> Frame
								</span> <span class="block1-info stext-102 trans-04"> Basic size
								</span>
							</div>
